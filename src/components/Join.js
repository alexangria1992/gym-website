  ...
  return (
    <section className="bg-neutral-500 min-h-[537px]">
      <div className="container mx-auto">
        {/* image & text wrapper */}
        <div
          className="flex flex-col md:flex-row md:items-center -space-y-24 md:-space-x-12 
        lg:space-y-0"
        >
          {/* Image */}
          <div
          ...
          >
            <h2
              className="text-white h1 md:text-[60px] md:leading-[62px]
            mb-4 lg:mb-6"
            >
              Wanna join <span className="text-primary-200">&</span> have fun?
            </h2>
            <p
              className="text-body-sm text-white md:text-body-md mb-4 lg:mb-6 max-w-[348px] 
