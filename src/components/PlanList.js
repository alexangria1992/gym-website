...
const PlanList = ({ plans }) => {
  ...
  return (
    <div className=" flex flex-col lg:flex-row items-center justify-center max-w-[1280px] gap-y-4">
                  ...
                  <div
                    className={`${
                      currentIndex === index
                        ...
                        : "bg-neutral-500 text-white"
                    } h-[26px] font-primary text-sm font-semibold min-w-min mx-auto px-[14px] flex items-center justify-center
                    mb-8 `}
                  >
                    {name}
                  </div>
